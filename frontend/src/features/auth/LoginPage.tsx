    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center">
      <div className="bg-gray-900 rounded-2xl p-10 flex flex-col items-center gap-6 shadow-xl">
        <div className="flex flex-col items-center gap-2">
          <h1 className="text-white text-3xl font-bold">DevFlow</h1>
          <p className="text-gray-400 text-sm">Your developer workspace</p>
        </div>
        ...
        <p className="text-gray-600 text-xs">Sign in to manage your projects</p>
      </div>
    </div>
  );
}
